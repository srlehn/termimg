...
func (t *termCheckerXTerm) CheckExclude(pr term.Properties) (mightBe bool, p term.Properties) {
...
func (t *termCheckerXTerm) CheckIsQuery(qu term.Querier, tty term.TTY, pr term.Properties) (is bool, p term.Properties) {
	p = environ.NewProperties()
	if t == nil || pr == nil {
...
func (t *termCheckerXTerm) CheckIsWindow(w wm.Window) (is bool, p term.Properties) {
	p = environ.NewProperties()
	if t == nil || w == nil {
...
func (t *termCheckerXTerm) Args(pr term.Properties) []string {
	return []string{
		`-fbx`, // enforce direct drawing (not font glyphs) of VT100 line-drawing characters
	}
}

func (t *termCheckerXTerm) Surveyor(pr term.Properties) term.PartialSurveyor {
