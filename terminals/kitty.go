...
func (t *termCheckerKitty) CheckExclude(pr environ.Properties) (mightBe bool, p environ.Properties) {
...
func (t *termCheckerKitty) CheckIsWindow(w wm.Window) (is bool, p environ.Properties) {
	p = environ.NewProprietor()
	if t == nil || w == nil {
