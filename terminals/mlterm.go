...
func (t *termCheckerMlterm) CheckExclude(pr term.Properties) (mightBe bool, p term.Properties) {
...
func (t *termCheckerMlterm) CheckIsWindow(w wm.Window) (is bool, p term.Properties) {
	p = environ.NewProperties()
	if t == nil || w == nil {
...
func (t *termCheckerMlterm) Args(pr term.Properties) []string {
	args := []string{
