...
func (t *termCheckerMintty) CheckExclude(pr term.Properties) (mightBe bool, p term.Properties) {
...
func (t *termCheckerMintty) CheckIsQuery(qu term.Querier, tty term.TTY, pr term.Properties) (is bool, p term.Properties) {
	p = environ.NewProperties()
	if t == nil || pr == nil {
