...
func (t *termCheckerConHost) CheckExclude(pr term.Properties) (mightBe bool, p term.Properties) {
...
func (t *termCheckerConHost) Windower(pr term.Properties) (wm.Window, error) {
	return getConHostWindow()
}
func (t *termCheckerConHost) Surveyor(pr term.Properties) term.PartialSurveyor {
