...
func (t *termCheckerURXVT) CheckExclude(pr term.Properties) (mightBe bool, p term.Properties) {
...
func (t *termCheckerURXVT) CheckIsQuery(qu term.Querier, tty term.TTY, pr term.Properties) (is bool, p term.Properties) {
...
func (t *termCheckerURXVT) CheckIsWindow(w wm.Window) (is bool, p term.Properties) {
	p = environ.NewProperties()
	if t == nil || w == nil {
...
func (t *termCheckerURXVT) Surveyor(pr term.Properties) term.PartialSurveyor {
