...
func (c colr) RGB() (int32, int32, int32) {
	v := c.Hex()
	if v < 0 {
		return -1, -1, -1
	}
...
func (c colr) TrueColor() colr {
	...
	return colr(c.Hex()) | ColorIsRGB | ColorValid
}
